 ...
 * @LastEditTime : 2025-08-10 13:39:44
 * @FilePath     : /root/lgc/RouterRL/modules/ipv4/RlBasicRoutingTable.cc
...
pair<string, int> RlBasicRoutingTable::getRoute(string path, Packet *packet)
{
    ...
    packet->par("stretch").setLongValue(packet->par("stretch").longValue() + 1);
    ...
    if (thisNodeId == dstNodeId) {
        ...
        cout << srcNodeId << "->" << dstNodeId << " stretch:" << packet->par("stretch").longValue() << endl;
